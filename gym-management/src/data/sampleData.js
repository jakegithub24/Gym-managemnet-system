...
export const offers = [
  {
    id: 'OFF-001', name: 'Independence Day Special', type: 'percentage', value: 15,
    code: 'INDIA15', applicablePlans: ['standard', 'premium', 'vip'],
    applicableCategories: ['Ladies', 'Mens', 'Mixed'],
    validFrom: '2026-08-10', validTo: '2026-08-31', status: 'Active',
    usageLimit: 100, timesUsed: 43,
    description: 'Flat 15% off on Standard, Premium & VIP plans. Independence Day celebration offer.',
  },
  {
    id: 'OFF-002', name: "Ladies' Special — Pink October", type: 'flat', value: 500,
    code: 'LADIES500', applicablePlans: ['basic', 'standard', 'premium', 'vip'],
    applicableCategories: ['Ladies'],
    validFrom: '2026-10-01', validTo: '2026-10-31', status: 'Upcoming',
    usageLimit: 200, timesUsed: 0,
    description: '₹500 off on all Ladies membership plans during Pink October.',
  },
  {
    id: 'OFF-003', name: 'First Month Free (Yearly)', type: 'percentage', value: 8,
    code: 'YEARLY8', applicablePlans: ['standard', 'premium'],
    applicableCategories: ['Ladies', 'Mens', 'Mixed'],
    validFrom: '2026-07-01', validTo: '2026-09-30', status: 'Active',
    usageLimit: 50, timesUsed: 22,
    description: 'Extra 8% off when you choose a yearly billing cycle on Standard or Premium plans.',
  },
  {
    id: 'OFF-004', name: 'Referral Bonus', type: 'flat', value: 300,
    code: 'REFER300', applicablePlans: ['basic', 'standard', 'premium', 'vip'],
    applicableCategories: ['Ladies', 'Mens', 'Mixed'],
    validFrom: '2026-01-01', validTo: '2026-12-31', status: 'Active',
    usageLimit: 500, timesUsed: 78,
    description: '₹300 off for members who were referred by an existing member.',
  },
  {
    id: 'OFF-005', name: 'New Year 2027 Launch Offer', type: 'percentage', value: 20,
    code: 'NY2027', applicablePlans: ['premium', 'vip'],
    applicableCategories: ['Ladies', 'Mens', 'Mixed'],
    validFrom: '2026-12-25', validTo: '2027-01-07', status: 'Upcoming',
    usageLimit: 75, timesUsed: 0,
    description: '20% off on Premium & VIP plans for New Year sign-ups.',
  },
  {
    id: 'OFF-006', name: 'Student Discount', type: 'percentage', value: 10,
    code: 'STUDENT10', applicablePlans: ['basic', 'standard'],
    applicableCategories: ['Ladies', 'Mens', 'Mixed'],
    validFrom: '2026-06-01', validTo: '2026-07-31', status: 'Expired',
    usageLimit: 100, timesUsed: 91,

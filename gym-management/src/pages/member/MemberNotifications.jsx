...
const MEMBER_NOTIFS = [
  ...
  { id: 2, title: 'Trainer Note Added', message: 'Mike Stone added a progress note to your profile. Check it out!', time: '3 hours ago', read: false, type: 'success' },
  { id: 3, title: 'Payment Confirmed', message: 'Your August payment of $89 was successfully processed.', time: '1 day ago', read: true, type: 'success' },

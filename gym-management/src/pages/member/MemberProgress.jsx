...
const weightTrend = [
  { month: 'Jan', weight: 185 }, { month: 'Feb', weight: 183 }, { month: 'Mar', weight: 181 },
  { month: 'Apr', weight: 180 }, { month: 'May', weight: 179 }, { month: 'Jun', weight: 178 },
  { month: 'Jul', weight: 177 }, { month: 'Aug', weight: 176 },
];
...
export default function MemberProgress() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Weight trend chart */}
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5">
        <h3 className="font-bold text-white mb-5 flex items-center gap-2"><TrendingUp size={15} className="text-[#39FF14]" />Weight Trend (lbs)</h3>
        <ResponsiveContainer width="100%" height={200}>
          <LineChart data={weightTrend}>
            <CartesianGrid strokeDasharray="3 3" stroke="#1f2937" />
            <XAxis dataKey="month" tick={{ fill: '#6b7280', fontSize: 12 }} axisLine={false} tickLine={false} />
            <YAxis domain={[170, 190]} tick={{ fill: '#6b7280', fontSize: 12 }} axisLine={false} tickLine={false} />
            <Tooltip contentStyle={{ background: '#111827', border: '1px solid #374151', borderRadius: '12px', fontSize: '12px' }} />
            <Line type="monotone" dataKey="weight" stroke="#39FF14" strokeWidth={2.5} dot={{ fill: '#39FF14', r: 4 }} name="Weight (lbs)" />
          </LineChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Weight Lost',     value: '9 lbs',              color: '#F59E0B' },

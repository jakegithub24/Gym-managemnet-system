...
import { Calendar, CreditCard, TrendingUp, Dumbbell, Clock, User, ArrowRight, CheckCircle, AlertTriangle } from 'lucide-react';
...
export default function MemberHome() {
  ...
  const quickStats = [
    { label: 'Sessions This Month', value: mp?.attendanceSummary?.thisMonth || 0,  color: '#39FF14', icon: Dumbbell },
    { label: 'Weekly Average',       value: mp?.attendanceSummary?.avgPerWeek || 0, color: '#00D4FF', icon: TrendingUp },
    { label: 'Total Sessions',        value: mp?.attendanceSummary?.totalSessions || 0, color: '#F59E0B', icon: Clock },
    { label: 'Days Left',             value: 26, color: '#A855F7', icon: Calendar },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {[
          ...
          { to: '/member/progress',  label: 'Progress',      icon: TrendingUp, desc: 'Track your improvements',color: '#A855F7' },
        ].map(item => (

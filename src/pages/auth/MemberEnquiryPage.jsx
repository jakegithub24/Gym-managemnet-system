...
// ── Bot reply logic ───────────────────────────────────────────────────────────
const BOT_RESPONSES = {
  price:    "Our plans start at $29/month (Basic) up to $149/month (VIP). We also offer annual plans with 2 months free! Would you like details on a specific plan?",
  plan:     "We have 4 plans:\n• Basic – $29/mo (gym access, lockers)\n• Standard – $59/mo (+ group classes)\n• Premium – $89/mo (+ PT sessions, spa)\n• VIP – $149/mo (unlimited everything)\n\nWhich sounds right for you?",
  ...
  location: "Our main gym is at 42 Fitness Avenue, Downtown. We have 2 more locations — Westside and Northpark. All branches are accessible with one membership!",
  trainer:  "Absolutely! We have certified personal trainers specialising in Strength, HIIT, Yoga, Nutrition, and Bodybuilding. PT sessions start from $40/session or are included in Premium/VIP plans.",
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3" noValidate>
      {[
        ...
        { label: 'Phone (optional)', key: 'phone', type: 'tel', placeholder: '+1 555-0000', icon: Phone },
      ].map(f => (
        <div key={f.key}>
...
export default function MemberEnquiryPage() {
  ...
  const gymInfo = [
    { icon: MapPin, label: '42 Fitness Avenue, Downtown', color: '#39FF14' },
    { icon: Clock, label: 'Mon–Fri 5AM–11PM · Weekends 6AM–10PM', color: '#00D4FF' },
    { icon: Phone, label: '+1 (555) 123-4567', color: '#FF6B00' },
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5">
              ...
              <div className="space-y-2">
                {[
                  { name: 'Basic', price: '$29', color: '#6B7280' },
                  { name: 'Standard', price: '$59', color: '#00D4FF' },
                  { name: 'Premium', price: '$89', color: '#39FF14' },
                  { name: 'VIP', price: '$149', color: '#FF6B00' },
                ].map(p => (
